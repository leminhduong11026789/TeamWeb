...
class BaseCommand extends Command
{
    ...
    public function handle()
    {
        ...
        /* getFields cập nhật thông tin cho mảng fields của CommandData: các đối tượng GeneratorFieds
         * */
    }
    ...
    private function saveSchemaFile()
    {
        ...
        $path = config('bloomgoo.laravel_generator.path.schema_files', base_path('resources/model_schemas/'));
