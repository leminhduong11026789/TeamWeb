...
class GeneratorPublishCommand extends PublishBaseCommand
{
     ...
     * @var string
     */
    protected $name = 'bloomgoo:publish';
    ...
    {
        $apiVersion = config('bloomgoo.laravel_generator.api_version', 'v1');
        $apiPrefix = config('bloomgoo.laravel_generator.api_prefix', 'api');
    ...
    private function publishTestCases()
    {
        ...
        $testsPath = config('bloomgoo.laravel_generator.path.api_test', base_path('tests/'));
