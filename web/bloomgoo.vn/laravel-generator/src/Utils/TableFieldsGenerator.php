...
namespace BloomGoo\Generator\Utils;

use DB;
use BloomGoo\Generator\Common\GeneratorField;
use BloomGoo\Generator\Common\GeneratorFieldRelation;
...
class TableFieldsGenerator
{
    ...
    public function __construct($tableName)
    {
        ...
        $this->defaultSearchable = config('bloomgoo.laravel_generator.options.tables_searchable_default', false);
    }
    ...
    {
        if (!config('bloomgoo.laravel_generator.timestamps.enabled', true)) {
            return [];
        }

        $createdAtName = config('bloomgoo.laravel_generator.timestamps.created_at', 'created_at');
        $updatedAtName = config('bloomgoo.laravel_generator.timestamps.updated_at', 'updated_at');
        $deletedAtName = config('bloomgoo.laravel_generator.timestamps.deleted_at', 'deleted_at');
