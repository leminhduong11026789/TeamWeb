...
namespace BloomGoo\Generator\Generators\Scaffold;
...
use BloomGoo\Generator\Utils\HTMLFieldGenerator;
...
class ViewGenerator extends BaseGenerator
{
    ...
    public function __construct(CommandData $commandData)
    {
        ...
        $this->templateType = config('bloomgoo.laravel_generator.templates', 'core-templates');
    }
