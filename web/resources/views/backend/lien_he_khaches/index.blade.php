    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red-sunglo bold uppercase">@lang("messages.khach_hang_index")</span>
            </div>
...
$('#items').submit();}")) }}
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li>
                            <form id="form_export_to_excel" style="display: inline" action="{{ route('admin.lienHeKhaches.export') }}" method="POST">
                                {{ csrf_field() }}
                        ...
                        <li>
                            <form id="form_export_to_csv" style="display: inline" action="{{ route('admin.lienHeKhaches.export') }}" method="POST">
                                {{ csrf_field() }}
                ...
                <a class="btn btn-icon-only btn-default reload" href="{!! route('admin.lienHeKhaches.index') !!}" data-original-title="Reload" title="Reload"> <i class="fa fa-repeat"></i></a>
                <a class="btn btn-icon-only btn-default fullscreen" href="javascript:;" data-original-title="" title=""> </a>
                {!! Form::open(['id' =>'items', 'route' => ['admin.lienHeKhaches.destroy', 'MULTI'], 'method' => 'delete']) !!}
                {!! Form::close() !!}
            </div>
        </div>
        ...
        <div class="box box-primary">
            <div class="box-header">
                {!! Form::open(['method' => 'GET','route' => 'admin.lienHeKhaches.index','role' => 'search']) !!}
            ...
            <div class="box-body">
                <div class="table-scrollable">
                    @include('backend.lien_he_khaches.table')
                </div>
            </div>
            @if($lienHeKhaches->hasPages())
                <div class="box-footer">
                    {!! $lienHeKhaches->appends(['search' => Request::get('search')])->render() !!}
                </div>
            @endif
        </div>
    </div>
