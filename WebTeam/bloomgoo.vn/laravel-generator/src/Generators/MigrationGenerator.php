...
class MigrationGenerator extends BaseGenerator
{
    ...
    public function __construct($commandData)
    {
        ...
        $this->path = config('bloomgoo.laravel_generator.path.migration', base_path('database/migrations/'));
    }
    ...
    public function generate()
    {
        ...
        // đến đây lấy được nội dung file migration .stub chưa thay thế gì cả
